...
> **0.13.7 dependency update:** this patch adopts Scientific Workflow 0.13.11
...
```toml
[dependencies]
ecological-state-toolkit = "0.13.7"
...
When used with Scientific Workflow 0.13.11, put recipes and other resolved
