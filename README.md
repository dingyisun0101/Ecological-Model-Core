...
> **0.13.4 dependency update:** this patch adopts Scientific Workflow 0.13.8
...
```toml
[dependencies]
ecological-state-toolkit = "0.13.4"
...
When used with Scientific Workflow 0.13.8, put recipes and other resolved
