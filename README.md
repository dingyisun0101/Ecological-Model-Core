...
> **0.13.8 dependency update:** this patch adopts Scientific Workflow 0.14.0
...
```toml
[dependencies]
ecological-state-toolkit = "0.13.8"
...
When used with Scientific Workflow 0.14.0, put recipes and other resolved
