...
> **0.13.9 dependency update:** this patch adopts Scientific Workflow 0.14.1
...
```toml
[dependencies]
ecological-state-toolkit = "0.13.9"
...
When used with Scientific Workflow 0.14.1, put recipes and other resolved
