...
> **0.13.6 dependency update:** this patch adopts Scientific Workflow 0.13.10
...
```toml
[dependencies]
ecological-state-toolkit = "0.13.6"
...
When used with Scientific Workflow 0.13.10, put recipes and other resolved
